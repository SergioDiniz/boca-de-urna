...
public class Votacao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTNumeroVoto.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTNumeroVotoActionPerformed(evt);
            }
        });
        if(this.acess.getStatus().equalsIgnoreCase("V")){
            jTNumeroVoto.setEnabled(false);
        }
    ...
    private void jTNumeroVotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTNumeroVotoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTNumeroVotoActionPerformed
